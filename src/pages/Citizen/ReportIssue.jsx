...
const ReportIssue = () => {
	...
	const handleSubmit = (e) => {
		...
		// Simulate network delay then redirect to success page
		setTimeout(() => {
			db.createIssue(issuePayload);
			setIsSubmitting(false);

			// Generate a specialized Reference ID for this session
			const refId = Math.floor(Math.random() * 900000) + 100000;
			navigate('/citizen/success', { state: { refId } });
		}, 800);
	};
