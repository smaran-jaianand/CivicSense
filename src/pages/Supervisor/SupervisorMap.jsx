                        ...
                        >
                            <Popup>
                                <div className="min-w-[200px]">
                                    <strong className="block text-lg mb-1">{issue.type}</strong>
                                    <span className={`text-xs px-2 py-0.5 rounded text-white ${issue.priority === 'Critical' ? 'bg-red-600' : 'bg-blue-500'}`}>
                                        {issue.priority}
                                    </span>
                                    <p className="my-2 text-sm text-gray-600 line-clamp-2">{issue.description}</p>
                                    <div className="text-xs text-muted mb-2">{issue.location}</div>

                                    <div className="flex flex-col gap-2 mt-3 pt-2 border-t border-gray-100">
                                        <a href={`/staff/task/${issue.id}`} className="text-blue-600 hover:underline text-sm font-semibold">View Ticket &rarr;</a>
