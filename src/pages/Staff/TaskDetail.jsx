...
const TaskDetail = () => {
    ...
    const handleStatusUpdate = (newStatus) => {
        db.updateIssue(task.id, { status: newStatus }, 'Staff Officer');
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md border border-[var(--color-border)] sticky top-24">
                        ...
                        <div className="space-y-6">
                            ...
                            {task.status === 'in_progress' && (
                                <button onClick={() => handleStatusUpdate('resolved')} className="btn btn-primary w-full justify-start bg-green-600 hover:bg-green-700">
